...
public class EmailSignUpEventMessageConsumer : IMessageConsumer<EmailSignUpEvent>
{
    private readonly ClientOptions _clientOptions;
    private readonly ISmtpEmailService _smtpEmailService;
    
    public EmailSignUpEventMessageConsumer(
    ...
    public async Task ConsumeAsync(EmailSignUpEvent @event, CancellationToken cancellationToken)
    {
